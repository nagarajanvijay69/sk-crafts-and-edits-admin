...
const Navbar = () => {
     ...
     return <>
          {
               log && <div className="nav-body text-orange-950 flex z-10 h-18 items-center justify-between px-5 relative w-full">
                    <h1 className="text-2xl font-bold text-brown-500 flex z-10"><Link href='/admin/home'>SK Edits and Crafts</Link></h1>
                    <ul className={`flex gap-7 z-0 font-semibold flex-col lg:flex-row absolute lg:static pl-5 lg:pl-0 h-60 lg:h-auto
                          ${Nav ? 'top-[76px] left-[0px] gap-7 pt-7  text-orange-950 bg-orange-100 w-full h-[100dvh] duration-500' : 'top-[76px] left-[-300px]'}`}>
